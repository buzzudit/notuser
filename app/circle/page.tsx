...
function buildPeopleAiContext() {
  ...
  return [
    "Circle page context for Udit Khandelwal's collaborator network.",
    ...
    "When answering, use the Circle page as a navigation aid. Point to /circle and relevant /portfolio pages when useful.",
  ].join("\n\n");
}
        ...
        <div className="grid gap-8 p-6 md:p-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(340px,0.85fr)] lg:p-10">
          <div className="relative z-10">
            ...
            <h1 className="max-w-3xl text-4xl font-semibold tracking-tight text-foreground md:text-5xl">
              The circle behind the work
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
              Collaborators, leaders, designers, product partners, and engineers
              connected to the projects, teams, and outcomes in this portfolio.
            </p>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <h2 className="mt-2 text-xl font-semibold tracking-tight text-foreground">
                  Start with the closest ties, then follow the work outward
                </h2>
              </div>
...
export default function CirclePage() {
  ...
  const peopleAiSuggestions = [
    ...
    "Which projects have the strongest collaborator evidence?",
  ...
  return (
    <PageLayout>
      ...
      <SectionShell>
        <CallToAction
          eyebrow="Collaborate"
          title="Build something meaningful together"
          description="This page maps the circle behind the work. If you want to explore fit, start a conversation or browse the portfolio first."
